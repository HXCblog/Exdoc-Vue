...
const LinkCateUrl='/api/linkcate';
const LinksUrl='/api/links?aid=';
export default
{
  BaseUrl,//服务器地址
  PageCateUrl, //文档分类(主页)API地址
  PageListUrl,  //文档列表API地址
  PageContentUrl,//文档详细内容API地址
  LinkCateUrl, //链接分类API地址
  LinksUrl,    //链接详情API地址
